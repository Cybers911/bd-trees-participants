...
public class ParticipantDirectory {
    ...
    public void addParticipant(Integer idNumber, String username, String fullname) {
        ...
        Participant p = new Participant(idNumber, username, fullname);//creating a Participant object
        this.usernameToParticipant.put(p.username, p);// storing the Participant object in the first
        // treeMap instance variable usernameToParticipant.

        // TODO 2: Store the Participant, p, in the second TreeMap
        // TODO 2: using the idNumber attribute of p as key.
        this.idToParticipant.put(p.idNumber, p); // storing the Participant object in the second
        // TreeMap instance variable id variable idToParticipant.
    ...
    public static void main(String[] args) {
        ...
        // Test code for the new TreeMap
        System.out.println("Participant with ID 3: " +
